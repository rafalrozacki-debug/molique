...
export const GLOBAL = {
  ...
  '--success-text':    ['palette', 'Przyciemniony wariant <code>--success</code> do WŁASNEGO koloru tekstu (<code>.text-success</code>, <code>.bg-success-subtle</code>) — baza nie ma dość kontrastu jako sam tekst na jasnym tle (ok. 2.6:1). Tła/badge/status-dot zostają przy zwykłym <code>--success</code>.'],
  '--danger':          ['palette', 'Błędy i akcje destrukcyjne: walidacja formularzy, przycisk Usuń.'],
  '--danger-hover':    ['palette', 'Danger po najechaniu.'],
  '--danger-text':     ['palette', 'Przyciemniony wariant <code>--danger</code> do własnego koloru tekstu — patrz <code>--success-text</code>.'],
  '--warning':         ['palette', 'Ostrzeżenia i stany oczekujące.'],
  '--warning-hover':   ['palette', 'Warning po najechaniu.'],
  '--warning-text':    ['palette', 'Przyciemniony wariant <code>--warning</code> do własnego koloru tekstu — patrz <code>--success-text</code>.'],
  ...
  '--btn-text-light': ['surfaces', 'Kolor napisu na przyciskach z ciemnym/nasyconym tłem (<code>.btn-primary</code>, <code>.btn-secondary</code>, <code>.btn-dark</code>). Odwraca się w dark mode.'],
  '--btn-text-dark':  ['surfaces', 'Literalny ciemny kolor napisu, <strong>NIE</strong> odwraca się w dark mode. Budulec dla <code>--semantic-fg</code> (jego wartość w dark mode) — sam bezpośrednio nie jest już używany przez komponenty.'],
  '--semantic-fg':    ['surfaces', 'Kolor napisu NA tle success/danger/warning/info (przyciski, badge, <code>.bg-success</code> itd.). Mode-aware — w przeciwieństwie do <code>--btn-text-dark</code>: w light mode te kolory są ciemne/nasycone (jasny tekst, <code>--btn-text-light</code>), w dark mode jasne/neonowe (ciemny tekst, <code>--btn-text-dark</code>).'],
  ...
  '--sidebar-active-accent': ['sidebar', 'Kolor marki na aktywnej pozycji w wariancie <code>.sidebar-sm</code> (ikony bez tła). Celowo literalne (wariant <code>--primary</code> z dark mode) — <code>var(--primary)</code> w light mode daje tylko 2.3:1 na zawsze ciemnym tle sidebara.'],
