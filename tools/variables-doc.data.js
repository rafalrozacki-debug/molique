...
export const GLOBAL = {
  ...
  '--btn-text-dark':  ['surfaces', 'Kolor napisu na jasnych/pastelowych tłach akcentowych (success, danger, warning, info, badge/przycisk pełny). Literalny, <strong>NIE</strong> odwraca się w dark mode — te tła są dość jasne w obu motywach, żeby zawsze potrzebować ciemnego tekstu.'],
