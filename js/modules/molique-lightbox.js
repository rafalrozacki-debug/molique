...
if (lightboxTriggers.length > 0) {
  ...
  if (!lightboxOverlay) {
    ...
    lightboxOverlay.innerHTML = `
      <div class="lightbox-top-bar" style="position:absolute; top:20px; width:100%; display:flex; justify-content:space-between; padding:0 20px; z-index:2010;">
        ...
        <button class="lightbox-close" style="background:none; border:none; color:#fff; font-size:2rem; cursor:pointer;">&times;</button>
      </div>
      <button class="lightbox-nav lightbox-prev" style="position:absolute; left:10px; top:50%; transform:translateY(-50%); background:none; border:none; color:#fff; font-size:3rem; cursor:pointer; z-index:2010;">&#10094;</button>
      ...
      <button class="lightbox-nav lightbox-next" style="position:absolute; right:10px; top:50%; transform:translateY(-50%); background:none; border:none; color:#fff; font-size:3rem; cursor:pointer; z-index:2010;">&#10095;</button>
    `;
  ...
  lightboxTriggers.forEach(trigger => {
    ...
    trigger.addEventListener('click', (e) => {
      ...
      setTimeout(() => lightboxOverlay.classList.add('is-active'), 10);
    });
  });
