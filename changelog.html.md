            ...
            <div class="timeline-content">
              <div class="card p-4">
                ...
                <ul class="text-secondary mb-4">
                  ...
                  <li>
                    <strong>Tło zawsze ciemne</strong> - pastylka leży na
                    zdjęciu, więc nie może jaśnieć w dark mode (pułapka
                    <code>var(--dark)</code>, które się odwraca). Podmiana jedną
                    zmienną: <code>style="--navbar-pill-bg: #123"</code>.
                  </li>
                  <li>
