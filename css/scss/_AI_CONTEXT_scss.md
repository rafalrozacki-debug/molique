...
@layer utilities {
  ...
  .bg-blobs::after {
    background-color: rgba(var(--info-rgb), 0.4); bottom: -10%; right: -10%;
  ...
  .bg-blobs-deep {
    ...
    /* Plamy mocniejsze, bo na ciemnym tle rozmyte kolory szybko gasną.
       Ustawiamy poziom BAZOWY - klatki pulsują względem niego. */
    &::before, &::after { --blob-opacity: 0.6; }
    &::before { background-color: rgba(var(--primary-rgb), 0.75); }
    &::after  { background-color: rgba(var(--info-rgb), 0.65); }
  }
